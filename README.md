...
```sh
cd ~
curl -fLO https://github.com/Harmonybrew/ohos-python/releases/download/3.14.4/python-3.14.4-ohos-arm64.tar.gz
tar -zxf python-3.14.4-ohos-arm64.tar.gz
export PATH=~/python-3.14.4-ohos-arm64/bin:$PATH
...
示例：
```sh
hdc file send python-3.14.4-ohos-arm64.tar.gz /data
hdc shell

cd /data
tar -zxf python-3.14.4-ohos-arm64.tar.gz
export PATH=/data/python-3.14.4-ohos-arm64/bin:$PATH
...
curl -fLO https://github.com/Harmonybrew/ohos-python/releases/download/3.14.4/python-3.14.4-ohos-arm64.tar.gz
tar -zxf python-3.14.4-ohos-arm64.tar.gz
export PATH=/opt/python-3.14.4-ohos-arm64/bin:$PATH
...
1. 将软件包放置到 prefix 目录下使用。本项目编包的时候设置的 prefix 是 /opt/python-3.14.4-ohos-arm64。
